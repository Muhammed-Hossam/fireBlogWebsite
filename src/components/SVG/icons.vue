<template>
  ...
  <svg
    v-else-if="name === 'arrow-right-light'"
    aria-hidden="true"
    focusable="false"
    data-prefix="fal"
  ...
  <svg
    v-else-if="name === 'envelop-regular'"
    aria-hidden="true"
    focusable="false"
    data-prefix="far"
    data-icon="envelope"
  ...
  <svg
    v-else-if="name === 'instagram-brands'"
    aria-hidden="true"
    focusable="false"
    data-prefix="fab"
    data-icon="instagram"
  ...
  <svg
    v-else-if="name === 'linkedin-brands'"
    aria-hidden="true"
    focusable="false"
    data-prefix="fab"
    data-icon="linkedin"
  ...
  <svg
    v-else-if="name === 'sign-out-alt-regular'"
    aria-hidden="true"
    focusable="false"
    data-prefix="far"
  ...
  <svg
    v-else-if="name === 'times-circle-light'"
    aria-hidden="true"
    focusable="false"
    data-prefix="fal"
  ...
  <svg
    v-else-if="name === 'user-crown-light'"
    aria-hidden="true"
    focusable="false"
    data-prefix="fal"
